...
$(function () {
       ...
       $("#btnrmvkml").click(function(){

              ctfastrak.setMap(null);
...
function initGoogleComponents() {
       ...
       mapView = new google.maps.InfoWindow({
       ...
       if (navigator.geolocation) {
              ...
              navigator.geolocation.getCurrentPosition(function (position) {
                     ...
                     handleLocationError(true, mapView, _map.getCenter());
              ...
              handleLocationError(false, mapView, _map.getCenter());
